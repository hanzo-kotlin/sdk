...
private constructor(
    ...
    private constructor(
         ...
         * import ai.hanzo.api.core.JsonValue
         *
         * val result: String? = endTime.accept(object : EndTime.Visitor<String?> {
         ...
         * ```
         *
         * @throws HanzoInvalidDataException if [Visitor.unknown] is not overridden in [visitor] and
    ...
    private constructor(
         ...
         * import ai.hanzo.api.core.JsonValue
         *
         * val result: String? = messages.accept(object : Messages.Visitor<String?> {
         *     override fun visitString(string: String): String? = string.toString()
         *
         *     // ...
         *
    ...
    private constructor(
         ...
         * import ai.hanzo.api.core.JsonValue
         *
         * val result: String? = response.accept(object : Response.Visitor<String?> {
         *     override fun visitString(string: String): String? = string.toString()
         *
         *     // ...
         *
    ...
    private constructor(
         ...
         * import ai.hanzo.api.core.JsonValue
         *
         * val result: String? = startTime.accept(object : StartTime.Visitor<String?> {
         *     override fun visitString(string: String): String? = string.toString()
         *
         *     // ...
         *
