...
private constructor(
    ...
    private constructor(
         ...
         * import ai.hanzo.api.core.JsonValue
         *
         * val result: String? = key.accept(object : Key.Visitor<String?> {
        ...
        private constructor(
            ...
            private constructor(
                 ...
                 * import ai.hanzo.api.core.JsonValue
                 *
                 * val result: String? = expires.accept(object : Expires.Visitor<String?> {
                 *     override fun visitString(string: String): String? = string.toString()
                 *
                 *     // ...
                 *
                 ...
                 * ```
                 *
                 * @throws HanzoInvalidDataException if [Visitor.unknown] is not overridden in
