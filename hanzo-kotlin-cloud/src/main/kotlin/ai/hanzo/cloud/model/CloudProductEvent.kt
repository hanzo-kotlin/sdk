 ...
 * @param event Event is the event name, e.g. $pageview.
 ...
 * @param type Type is the canonical kind: pageview, error, identify, group or event.
 * @param url URL is the full page address the event fired on. Omitted when absent.
 */


data class CloudProductEvent (
