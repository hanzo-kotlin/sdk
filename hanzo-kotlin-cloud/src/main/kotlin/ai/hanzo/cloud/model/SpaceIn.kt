 ...
 * 
 *
 * @param name Name is the space's name, matching ^[a-z0-9]([a-z0-9-]{0,38}[a-z0-9])?$ — the shape a drive name takes too, so a caller learns one rule. It is validated AS GIVEN and never lower-cased for you: a client that creates \"Photos\" and then lists \"photos\" would be reading a space it did not make, so mixed case is a clean 400.
 */
