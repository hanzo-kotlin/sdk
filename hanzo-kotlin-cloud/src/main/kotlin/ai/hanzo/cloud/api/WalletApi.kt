...
class WalletApi(basePath: kotlin.String = defaultBasePath, client: Call.Factory = ApiClient.defaultClient) : ApiClient(basePath, client) {
    ...
    fun getWallet(project: kotlin.String? = null, agent: kotlin.String? = null, account: kotlin.String? = null) : WalletList {
        val localVarResponse = getWalletWithHttpInfo(project = project, agent = agent, account = account)
    ...
    fun getWalletWithHttpInfo(project: kotlin.String?, agent: kotlin.String?, account: kotlin.String?) : ApiResponse<WalletList?> {
        val localVariableConfig = getWalletRequestConfig(project = project, agent = agent, account = account)
     ...
     */
    fun getWalletRequestConfig(project: kotlin.String?, agent: kotlin.String?, account: kotlin.String?) : RequestConfig<Unit> {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getWalletAccounts() : AccountList {
        val localVarResponse = getWalletAccountsWithHttpInfo()
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun getWalletAccountsWithHttpInfo() : ApiResponse<AccountList?> {
        val localVariableConfig = getWalletAccountsRequestConfig()
    ...
    /**
     * To obtain the request config of the operation getWalletAccounts
     *
     * @return RequestConfig
     */
    fun getWalletAccountsRequestConfig() : RequestConfig<Unit> {
        val localVariableBody = null
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getWalletById(id: kotlin.String) : Wallet {
        val localVarResponse = getWalletByIdWithHttpInfo(id = id)
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun getWalletByIdWithHttpInfo(id: kotlin.String) : ApiResponse<Wallet?> {
        val localVariableConfig = getWalletByIdRequestConfig(id = id)
    ...
    /**
     * To obtain the request config of the operation getWalletById
     *
     * @param id 
     * @return RequestConfig
     */
    fun getWalletByIdRequestConfig(id: kotlin.String) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        localVariableHeaders["Accept"] = "application/json"
        ...
        return RequestConfig(
            method = RequestMethod.GET,
            path = "/v1/wallet/{id}".replace("{"+"id"+"}", encodeURIComponent(id.toString())),
            query = localVariableQuery,
            headers = localVariableHeaders,
            requiresAuthentication = true,
            body = localVariableBody
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun postWallet(createWalletIn: CreateWalletIn) : Wallet {
        val localVarResponse = postWalletWithHttpInfo(createWalletIn = createWalletIn)
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun postWalletWithHttpInfo(createWalletIn: CreateWalletIn) : ApiResponse<Wallet?> {
        val localVariableConfig = postWalletRequestConfig(createWalletIn = createWalletIn)
    ...
    /**
     * To obtain the request config of the operation postWallet
     *
     * @param createWalletIn 
     * @return RequestConfig
     */
    fun postWalletRequestConfig(createWalletIn: CreateWalletIn) : RequestConfig<CreateWalletIn> {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun postWalletAccounts(createAccountIn: CreateAccountIn) : WalletAccount {
        val localVarResponse = postWalletAccountsWithHttpInfo(createAccountIn = createAccountIn)
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun postWalletAccountsWithHttpInfo(createAccountIn: CreateAccountIn) : ApiResponse<WalletAccount?> {
        val localVariableConfig = postWalletAccountsRequestConfig(createAccountIn = createAccountIn)
    ...
    /**
     * To obtain the request config of the operation postWalletAccounts
     *
     * @param createAccountIn 
     * @return RequestConfig
     */
    fun postWalletAccountsRequestConfig(createAccountIn: CreateAccountIn) : RequestConfig<CreateAccountIn> {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun postWalletByIdKeys(id: kotlin.String) : Wallet {
        val localVarResponse = postWalletByIdKeysWithHttpInfo(id = id)
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun postWalletByIdKeysWithHttpInfo(id: kotlin.String) : ApiResponse<Wallet?> {
        val localVariableConfig = postWalletByIdKeysRequestConfig(id = id)
    ...
    /**
     * To obtain the request config of the operation postWalletByIdKeys
     *
     * @param id 
     * @return RequestConfig
     */
    fun postWalletByIdKeysRequestConfig(id: kotlin.String) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        localVariableHeaders["Accept"] = "application/json"
        ...
        return RequestConfig(
            method = RequestMethod.POST,
            path = "/v1/wallet/{id}/keys".replace("{"+"id"+"}", encodeURIComponent(id.toString())),
            query = localVariableQuery,
            headers = localVariableHeaders,
            requiresAuthentication = true,
            body = localVariableBody
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun postWalletByIdSign(id: kotlin.String, signIn: SignIn) : Signature {
        val localVarResponse = postWalletByIdSignWithHttpInfo(id = id, signIn = signIn)
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun postWalletByIdSignWithHttpInfo(id: kotlin.String, signIn: SignIn) : ApiResponse<Signature?> {
        val localVariableConfig = postWalletByIdSignRequestConfig(id = id, signIn = signIn)
    ...
    /**
     * To obtain the request config of the operation postWalletByIdSign
     *
     * @param id 
     * @param signIn 
     * @return RequestConfig
     */
    fun postWalletByIdSignRequestConfig(id: kotlin.String, signIn: SignIn) : RequestConfig<SignIn> {
        ...
        return RequestConfig(
            method = RequestMethod.POST,
            path = "/v1/wallet/{id}/sign".replace("{"+"id"+"}", encodeURIComponent(id.toString())),
            query = localVariableQuery,
            headers = localVariableHeaders,
            requiresAuthentication = true,
            body = localVariableBody
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun postWalletByIdTransactions(id: kotlin.String, safeTxIn: SafeTxIn) : SafeProposal {
        val localVarResponse = postWalletByIdTransactionsWithHttpInfo(id = id, safeTxIn = safeTxIn)
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun postWalletByIdTransactionsWithHttpInfo(id: kotlin.String, safeTxIn: SafeTxIn) : ApiResponse<SafeProposal?> {
        val localVariableConfig = postWalletByIdTransactionsRequestConfig(id = id, safeTxIn = safeTxIn)
    ...
    /**
     * To obtain the request config of the operation postWalletByIdTransactions
     *
     * @param id 
     * @param safeTxIn 
     * @return RequestConfig
     */
    fun postWalletByIdTransactionsRequestConfig(id: kotlin.String, safeTxIn: SafeTxIn) : RequestConfig<SafeTxIn> {
        ...
        return RequestConfig(
            method = RequestMethod.POST,
            path = "/v1/wallet/{id}/transactions".replace("{"+"id"+"}", encodeURIComponent(id.toString())),
            query = localVariableQuery,
            headers = localVariableHeaders,
            requiresAuthentication = true,
            body = localVariableBody
