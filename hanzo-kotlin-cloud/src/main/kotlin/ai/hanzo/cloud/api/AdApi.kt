...
class AdApi(basePath: kotlin.String = defaultBasePath, client: Call.Factory = ApiClient.defaultClient) : ApiClient(basePath, client) {
    companion object {
        @JvmStatic
    ...
    fun deleteAdCampaignsById(id: kotlin.String) : Unit {
        val localVarResponse = deleteAdCampaignsByIdWithHttpInfo(id = id)
    ...
    fun deleteAdCampaignsByIdWithHttpInfo(id: kotlin.String) : ApiResponse<Unit?> {
        val localVariableConfig = deleteAdCampaignsByIdRequestConfig(id = id)
    ...
    /**
     * To obtain the request config of the operation deleteAdCampaignsById
     *
     * @param id 
     * @return RequestConfig
     */
    fun deleteAdCampaignsByIdRequestConfig(id: kotlin.String) : RequestConfig<Unit> {
        ...
        return RequestConfig(
            ...
            path = "/v1/ad/campaigns/{id}".replace("{"+"id"+"}", encodeURIComponent(id.toString())),
    ...
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getAdCampaigns(status: kotlin.String? = null, limit: kotlin.Int? = null) : CampaignList {
        val localVarResponse = getAdCampaignsWithHttpInfo(status = status, limit = limit)
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun getAdCampaignsWithHttpInfo(status: kotlin.String?, limit: kotlin.Int?) : ApiResponse<CampaignList?> {
        val localVariableConfig = getAdCampaignsRequestConfig(status = status, limit = limit)
    ...
    /**
     * To obtain the request config of the operation getAdCampaigns
     *
     * @param status Status filters to one lifecycle state (draft, active, paused, completed). Empty returns every campaign the org has. (optional)
     * @param limit Limit caps how many campaigns come back: default 200, maximum 1000. A value that is not a positive integer reads as the default. (optional)
     * @return RequestConfig
     */
    fun getAdCampaignsRequestConfig(status: kotlin.String?, limit: kotlin.Int?) : RequestConfig<Unit> {
        val localVariableBody = null
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getAdCampaignsById(id: kotlin.String) : AdCampaign {
        val localVarResponse = getAdCampaignsByIdWithHttpInfo(id = id)
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun getAdCampaignsByIdWithHttpInfo(id: kotlin.String) : ApiResponse<AdCampaign?> {
        val localVariableConfig = getAdCampaignsByIdRequestConfig(id = id)
    ...
    /**
     * To obtain the request config of the operation getAdCampaignsById
     *
     * @param id 
     * @return RequestConfig
     */
    fun getAdCampaignsByIdRequestConfig(id: kotlin.String) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        localVariableHeaders["Accept"] = "application/json"
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getAdSummary() : AdSummary {
        val localVarResponse = getAdSummaryWithHttpInfo()
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun getAdSummaryWithHttpInfo() : ApiResponse<AdSummary?> {
        val localVariableConfig = getAdSummaryRequestConfig()
    ...
    /**
     * To obtain the request config of the operation getAdSummary
     *
     * @return RequestConfig
     */
    fun getAdSummaryRequestConfig() : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        localVariableHeaders["Accept"] = "application/json"
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun postAdCampaigns(campaignInput: CampaignInput) : AdCampaign {
        val localVarResponse = postAdCampaignsWithHttpInfo(campaignInput = campaignInput)
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun postAdCampaignsWithHttpInfo(campaignInput: CampaignInput) : ApiResponse<AdCampaign?> {
        val localVariableConfig = postAdCampaignsRequestConfig(campaignInput = campaignInput)
    ...
    /**
     * To obtain the request config of the operation postAdCampaigns
     *
     * @param campaignInput 
     * @return RequestConfig
     */
    fun postAdCampaignsRequestConfig(campaignInput: CampaignInput) : RequestConfig<CampaignInput> {
     ...
     */
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun postAdCampaignsByIdLaunch(id: kotlin.String) : Unit {
        val localVarResponse = postAdCampaignsByIdLaunchWithHttpInfo(id = id)
     ...
     */
    @Throws(IllegalStateException::class, IOException::class)
    fun postAdCampaignsByIdLaunchWithHttpInfo(id: kotlin.String) : ApiResponse<Unit?> {
        val localVariableConfig = postAdCampaignsByIdLaunchRequestConfig(id = id)
    ...
    /**
     * To obtain the request config of the operation postAdCampaignsByIdLaunch
     *
     * @param id 
     * @return RequestConfig
     */
    fun postAdCampaignsByIdLaunchRequestConfig(id: kotlin.String) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        ...
        return RequestConfig(
            method = RequestMethod.POST,
            path = "/v1/ad/campaigns/{id}/launch".replace("{"+"id"+"}", encodeURIComponent(id.toString())),
            query = localVariableQuery,
            headers = localVariableHeaders,
            requiresAuthentication = true,
            body = localVariableBody
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun putAdCampaignsById(id: kotlin.String, updateCampaignIn: UpdateCampaignIn) : AdCampaign {
        val localVarResponse = putAdCampaignsByIdWithHttpInfo(id = id, updateCampaignIn = updateCampaignIn)
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun putAdCampaignsByIdWithHttpInfo(id: kotlin.String, updateCampaignIn: UpdateCampaignIn) : ApiResponse<AdCampaign?> {
        val localVariableConfig = putAdCampaignsByIdRequestConfig(id = id, updateCampaignIn = updateCampaignIn)
    ...
    /**
     * To obtain the request config of the operation putAdCampaignsById
     *
     * @param id 
     * @param updateCampaignIn 
     * @return RequestConfig
     */
    fun putAdCampaignsByIdRequestConfig(id: kotlin.String, updateCampaignIn: UpdateCampaignIn) : RequestConfig<UpdateCampaignIn> {
