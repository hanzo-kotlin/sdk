...
class EmbedStatusApi(basePath: kotlin.String = defaultBasePath, client: Call.Factory = ApiClient.defaultClient) : ApiClient(basePath, client) {
    companion object {
        @JvmStatic
    ...
    fun cloudGetV1EmbedStatus(app: kotlin.String? = null) : CloudEmbedStatusResp {
        val localVarResponse = cloudGetV1EmbedStatusWithHttpInfo(app = app)

        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as CloudEmbedStatusResp
    ...
    fun cloudGetV1EmbedStatusWithHttpInfo(app: kotlin.String?) : ApiResponse<CloudEmbedStatusResp?> {
        val localVariableConfig = cloudGetV1EmbedStatusRequestConfig(app = app)

        return request<Unit, CloudEmbedStatusResp>(
            localVariableConfig
        )
    }

    /**
     * To obtain the request config of the operation cloudGetV1EmbedStatus
     *
     * @param app App is the embedded app to report on: cms (Content Studio), erp or help. (optional)
     * @return RequestConfig
     */
    fun cloudGetV1EmbedStatusRequestConfig(app: kotlin.String?) : RequestConfig<Unit> {
