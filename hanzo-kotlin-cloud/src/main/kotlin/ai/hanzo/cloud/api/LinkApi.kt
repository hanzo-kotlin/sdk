...
class LinkApi(basePath: kotlin.String = defaultBasePath, client: Call.Factory = ApiClient.defaultClient) : ApiClient(basePath, client) {
    companion object {
        @JvmStatic
    ...
    fun deleteLinkById(id: kotlin.String) : RevokeResp {
        val localVarResponse = deleteLinkByIdWithHttpInfo(id = id)
    ...
    fun deleteLinkByIdWithHttpInfo(id: kotlin.String) : ApiResponse<RevokeResp?> {
        val localVariableConfig = deleteLinkByIdRequestConfig(id = id)
    ...
    /**
     * To obtain the request config of the operation deleteLinkById
     *
     * @param id ID is the link to act on, from the path. It is scoped to the caller, so another user&#39;s or org&#39;s id is a 404.
     * @return RequestConfig
     */
    fun deleteLinkByIdRequestConfig(id: kotlin.String) : RequestConfig<Unit> {
        ...
        return RequestConfig(
            ...
            path = "/v1/link/{id}".replace("{"+"id"+"}", encodeURIComponent(id.toString())),
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getLink() : LinkList {
        val localVarResponse = getLinkWithHttpInfo()
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun getLinkWithHttpInfo() : ApiResponse<LinkList?> {
        val localVariableConfig = getLinkRequestConfig()
    ...
    /**
     * To obtain the request config of the operation getLink
     *
     * @return RequestConfig
     */
    fun getLinkRequestConfig() : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        localVariableHeaders["Accept"] = "application/json"
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getLinkById(id: kotlin.String) : LinkView {
        val localVarResponse = getLinkByIdWithHttpInfo(id = id)
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun getLinkByIdWithHttpInfo(id: kotlin.String) : ApiResponse<LinkView?> {
        val localVariableConfig = getLinkByIdRequestConfig(id = id)
    ...
    /**
     * To obtain the request config of the operation getLinkById
     *
     * @param id ID is the link to act on, from the path. It is scoped to the caller, so another user&#39;s or org&#39;s id is a 404.
     * @return RequestConfig
     */
    fun getLinkByIdRequestConfig(id: kotlin.String) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        localVariableHeaders["Accept"] = "application/json"
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getLinkDevicesByMachine(machine: kotlin.String) : DeviceView {
        val localVarResponse = getLinkDevicesByMachineWithHttpInfo(machine = machine)
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun getLinkDevicesByMachineWithHttpInfo(machine: kotlin.String) : ApiResponse<DeviceView?> {
        val localVariableConfig = getLinkDevicesByMachineRequestConfig(machine = machine)
    ...
    /**
     * To obtain the request config of the operation getLinkDevicesByMachine
     *
     * @param machine Machine is the machine to act on, from the path. It is scoped to the caller, so a machine with none of the caller&#39;s accounts is a 404.
     * @return RequestConfig
     */
    fun getLinkDevicesByMachineRequestConfig(machine: kotlin.String) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        localVariableHeaders["Accept"] = "application/json"
        ...
        return RequestConfig(
            method = RequestMethod.GET,
            path = "/v1/link/devices/{machine}".replace("{"+"machine"+"}", encodeURIComponent(machine.toString())),
            query = localVariableQuery,
            headers = localVariableHeaders,
            requiresAuthentication = true,
            body = localVariableBody
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getLinkRoute() : RoutePlan {
        val localVarResponse = getLinkRouteWithHttpInfo()
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun getLinkRouteWithHttpInfo() : ApiResponse<RoutePlan?> {
        val localVariableConfig = getLinkRouteRequestConfig()
    ...
    /**
     * To obtain the request config of the operation getLinkRoute
     *
     * @return RequestConfig
     */
    fun getLinkRouteRequestConfig() : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        localVariableHeaders["Accept"] = "application/json"
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getLinkUsage(provider: kotlin.String? = null, account: kotlin.String? = null, window: kotlin.String? = null, range: kotlin.String? = null) : BoardResp {
        val localVarResponse = getLinkUsageWithHttpInfo(provider = provider, account = account, window = window, range = range)
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun getLinkUsageWithHttpInfo(provider: kotlin.String?, account: kotlin.String?, window: kotlin.String?, range: kotlin.String?) : ApiResponse<BoardResp?> {
        val localVariableConfig = getLinkUsageRequestConfig(provider = provider, account = account, window = window, range = range)
    ...
    /**
     * To obtain the request config of the operation getLinkUsage
     *
     * @param provider Provider is the provider whose meter to read. Required. (optional)
     * @param account Account narrows to one account when a user has several with the provider. (optional)
     * @param window Window selects a window class: 6h, day, week or month. Empty reads all. (optional)
     ...
     * @return RequestConfig
     */
    fun getLinkUsageRequestConfig(provider: kotlin.String?, account: kotlin.String?, window: kotlin.String?, range: kotlin.String?) : RequestConfig<Unit> {
        val localVariableBody = null
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getLinkUsageAccounts() : AccountsUsage {
        val localVarResponse = getLinkUsageAccountsWithHttpInfo()
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun getLinkUsageAccountsWithHttpInfo() : ApiResponse<AccountsUsage?> {
        val localVariableConfig = getLinkUsageAccountsRequestConfig()
    ...
    /**
     * To obtain the request config of the operation getLinkUsageAccounts
     *
     * @return RequestConfig
     */
    fun getLinkUsageAccountsRequestConfig() : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        localVariableHeaders["Accept"] = "application/json"
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getLinkUsageSummary(range: kotlin.String? = null) : SummaryResp {
        val localVarResponse = getLinkUsageSummaryWithHttpInfo(range = range)
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun getLinkUsageSummaryWithHttpInfo(range: kotlin.String?) : ApiResponse<SummaryResp?> {
        val localVariableConfig = getLinkUsageSummaryRequestConfig(range = range)
    ...
    /**
     * To obtain the request config of the operation getLinkUsageSummary
     *
     * @param range Range is the period, one of 1h, 24h, 7d or 30d; empty means 24h, and an unknown label is 400, never a silent substitution. (optional)
     * @return RequestConfig
     */
    fun getLinkUsageSummaryRequestConfig(range: kotlin.String?) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, kotlin.collections.List<kotlin.String>>()
            .apply {
                if (range != null) {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun postLink(enrollReq: EnrollReq) : LinkView {
        val localVarResponse = postLinkWithHttpInfo(enrollReq = enrollReq)
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun postLinkWithHttpInfo(enrollReq: EnrollReq) : ApiResponse<LinkView?> {
        val localVariableConfig = postLinkRequestConfig(enrollReq = enrollReq)
    ...
    /**
     * To obtain the request config of the operation postLink
     *
     * @param enrollReq 
     * @return RequestConfig
     */
    fun postLinkRequestConfig(enrollReq: EnrollReq) : RequestConfig<EnrollReq> {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun postLinkDevicesByMachineRevoke(machine: kotlin.String) : RevokeResp {
        val localVarResponse = postLinkDevicesByMachineRevokeWithHttpInfo(machine = machine)
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun postLinkDevicesByMachineRevokeWithHttpInfo(machine: kotlin.String) : ApiResponse<RevokeResp?> {
        val localVariableConfig = postLinkDevicesByMachineRevokeRequestConfig(machine = machine)
    ...
    /**
     * To obtain the request config of the operation postLinkDevicesByMachineRevoke
     *
     * @param machine Machine is the machine to act on, from the path. It is scoped to the caller, so a machine with none of the caller&#39;s accounts is a 404.
     * @return RequestConfig
     */
    fun postLinkDevicesByMachineRevokeRequestConfig(machine: kotlin.String) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        localVariableHeaders["Accept"] = "application/json"
        ...
        return RequestConfig(
            method = RequestMethod.POST,
            path = "/v1/link/devices/{machine}/revoke".replace("{"+"machine"+"}", encodeURIComponent(machine.toString())),
            query = localVariableQuery,
            headers = localVariableHeaders,
            requiresAuthentication = true,
            body = localVariableBody
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun postLinkUsage(ingestReq: IngestReq) : IngestResp {
        val localVarResponse = postLinkUsageWithHttpInfo(ingestReq = ingestReq)
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun postLinkUsageWithHttpInfo(ingestReq: IngestReq) : ApiResponse<IngestResp?> {
        val localVariableConfig = postLinkUsageRequestConfig(ingestReq = ingestReq)
    ...
    /**
     * To obtain the request config of the operation postLinkUsage
     *
     * @param ingestReq 
     * @return RequestConfig
     */
    fun postLinkUsageRequestConfig(ingestReq: IngestReq) : RequestConfig<IngestReq> {
