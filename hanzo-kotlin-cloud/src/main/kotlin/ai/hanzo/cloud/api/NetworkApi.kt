...
class NetworkApi(basePath: kotlin.String = defaultBasePath, client: Call.Factory = ApiClient.defaultClient) : ApiClient(basePath, client) {
    ...
    fun getNetwork() : NetworkList {
        val localVarResponse = getNetworkWithHttpInfo()
    ...
    fun getNetworkWithHttpInfo() : ApiResponse<NetworkList?> {
        val localVariableConfig = getNetworkRequestConfig()
     ...
     */
    fun getNetworkRequestConfig() : RequestConfig<Unit> {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getNetworkById(id: kotlin.String) : NetworkView {
        val localVarResponse = getNetworkByIdWithHttpInfo(id = id)
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun getNetworkByIdWithHttpInfo(id: kotlin.String) : ApiResponse<NetworkView?> {
        val localVariableConfig = getNetworkByIdRequestConfig(id = id)
    ...
    /**
     * To obtain the request config of the operation getNetworkById
     *
     * @param id ID is the network id from the path. The URL is the addressing authority, so it binds from there whatever else the request carries.
     * @return RequestConfig
     */
    fun getNetworkByIdRequestConfig(id: kotlin.String) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        localVariableHeaders["Accept"] = "application/json"
        ...
        return RequestConfig(
            method = RequestMethod.GET,
            path = "/v1/network/{id}".replace("{"+"id"+"}", encodeURIComponent(id.toString())),
            query = localVariableQuery,
            headers = localVariableHeaders,
            requiresAuthentication = true,
            body = localVariableBody
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getNetworkRouters() : RouterList {
        val localVarResponse = getNetworkRoutersWithHttpInfo()
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun getNetworkRoutersWithHttpInfo() : ApiResponse<RouterList?> {
        val localVariableConfig = getNetworkRoutersRequestConfig()
    ...
    /**
     * To obtain the request config of the operation getNetworkRouters
     *
     * @return RequestConfig
     */
    fun getNetworkRoutersRequestConfig() : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        localVariableHeaders["Accept"] = "application/json"
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getNetworkServices() : MeshServiceList {
        val localVarResponse = getNetworkServicesWithHttpInfo()
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun getNetworkServicesWithHttpInfo() : ApiResponse<MeshServiceList?> {
        val localVariableConfig = getNetworkServicesRequestConfig()
    ...
    /**
     * To obtain the request config of the operation getNetworkServices
     *
     * @return RequestConfig
     */
    fun getNetworkServicesRequestConfig() : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        localVariableHeaders["Accept"] = "application/json"
