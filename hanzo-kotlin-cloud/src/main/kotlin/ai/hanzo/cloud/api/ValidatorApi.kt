...
class ValidatorApi(basePath: kotlin.String = defaultBasePath, client: Call.Factory = ApiClient.defaultClient) : ApiClient(basePath, client) {
    companion object {
        @JvmStatic
    ...
    fun getValidator(limit: kotlin.String? = null) : ValidatorList {
        val localVarResponse = getValidatorWithHttpInfo(limit = limit)
    ...
    fun getValidatorWithHttpInfo(limit: kotlin.String?) : ApiResponse<ValidatorList?> {
        val localVariableConfig = getValidatorRequestConfig(limit = limit)
    ...
    /**
     * To obtain the request config of the operation getValidator
     *
     * @param limit Limit is how many slots to return, as a decimal string in the &#x60;?limit&#x3D;&#x60; query. Absent, unparseable or non-positive means 200; over 1000 is clamped to 1000. It is a string rather than a number because the parse that has always served this route trims surrounding whitespace, and one parse rule is better than two. (optional)
     * @return RequestConfig
     */
    fun getValidatorRequestConfig(limit: kotlin.String?) : RequestConfig<Unit> {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getValidatorByTokenid(tokenId: kotlin.String) : SlotView {
        val localVarResponse = getValidatorByTokenidWithHttpInfo(tokenId = tokenId)
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun getValidatorByTokenidWithHttpInfo(tokenId: kotlin.String) : ApiResponse<SlotView?> {
        val localVariableConfig = getValidatorByTokenidRequestConfig(tokenId = tokenId)
    ...
    /**
     * To obtain the request config of the operation getValidatorByTokenid
     *
     * @param tokenId TokenID is the slot&#39;s GenesisNFT token id, from the path, as a decimal string. A value that is not a positive integer is 400. It is a string rather than a number because the parse that has always served this route trims surrounding whitespace, and one parse rule is better than two.
     * @return RequestConfig
     */
    fun getValidatorByTokenidRequestConfig(tokenId: kotlin.String) : RequestConfig<Unit> {
        val localVariableBody = null
        ...
        return RequestConfig(
            method = RequestMethod.GET,
            path = "/v1/validator/{tokenId}".replace("{"+"tokenId"+"}", encodeURIComponent(tokenId.toString())),
            query = localVariableQuery,
            headers = localVariableHeaders,
            requiresAuthentication = true,
            body = localVariableBody
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getValidatorChallenge(tokenId: kotlin.String? = null) : ChallengeView {
        val localVarResponse = getValidatorChallengeWithHttpInfo(tokenId = tokenId)
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun getValidatorChallengeWithHttpInfo(tokenId: kotlin.String?) : ApiResponse<ChallengeView?> {
        val localVariableConfig = getValidatorChallengeRequestConfig(tokenId = tokenId)
    ...
    /**
     * To obtain the request config of the operation getValidatorChallenge
     *
     * @param tokenId TokenID is the Validator-tier GenesisNFT token id, as a decimal string in the &#x60;?tokenId&#x3D;&#x60; query. A value that is not a positive integer is 400. It is a string rather than a number because the parse that has always served this route trims surrounding whitespace, and one parse rule is better than two. (optional)
     * @return RequestConfig
     */
    fun getValidatorChallengeRequestConfig(tokenId: kotlin.String?) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, kotlin.collections.List<kotlin.String>>()
            .apply {
                if (tokenId != null) {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun postValidator(validatorClaim: ValidatorClaim) : SlotView {
        val localVarResponse = postValidatorWithHttpInfo(validatorClaim = validatorClaim)
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun postValidatorWithHttpInfo(validatorClaim: ValidatorClaim) : ApiResponse<SlotView?> {
        val localVariableConfig = postValidatorRequestConfig(validatorClaim = validatorClaim)
    ...
    /**
     * To obtain the request config of the operation postValidator
     *
     * @param validatorClaim 
     * @return RequestConfig
     */
    fun postValidatorRequestConfig(validatorClaim: ValidatorClaim) : RequestConfig<ValidatorClaim> {
