...
class TeamApi(basePath: kotlin.String = defaultBasePath, client: Call.Factory = ApiClient.defaultClient) : ApiClient(basePath, client) {
     ...
     */
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun deleteTeamFilesBySpaceByFilename(space: kotlin.String, filename: kotlin.String, file: kotlin.String? = null) : Unit {
        val localVarResponse = deleteTeamFilesBySpaceByFilenameWithHttpInfo(space = space, filename = filename, file = file)
     ...
     */
    @Throws(IllegalStateException::class, IOException::class)
    fun deleteTeamFilesBySpaceByFilenameWithHttpInfo(space: kotlin.String, filename: kotlin.String, file: kotlin.String?) : ApiResponse<Unit?> {
        val localVariableConfig = deleteTeamFilesBySpaceByFilenameRequestConfig(space = space, filename = filename, file = file)
    ...
    /**
     * To obtain the request config of the operation deleteTeamFilesBySpaceByFilename
     *
     * @param space Space is the space uuid the blob belongs to, from the path.
     * @param filename Filename is the last path segment, which the front sets to the blob id when it sends no explicit &#x60;file&#x60;.
     * @param file File is the blob id, and wins over the path segment when both are present. (optional)
     * @return RequestConfig
     */
    fun deleteTeamFilesBySpaceByFilenameRequestConfig(space: kotlin.String, filename: kotlin.String, file: kotlin.String?) : RequestConfig<Unit> {
        val localVariableBody = null
        ...
        return RequestConfig(
            method = RequestMethod.DELETE,
            path = "/v1/team/files/{space}/{filename}".replace("{"+"space"+"}", encodeURIComponent(space.toString())).replace("{"+"filename"+"}", encodeURIComponent(filename.toString())),
            query = localVariableQuery,
            headers = localVariableHeaders,
            requiresAuthentication = true,
            body = localVariableBody
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getTeamFilesBySpaceByFilename(space: kotlin.String, filename: kotlin.String) : java.io.File {
        val localVarResponse = getTeamFilesBySpaceByFilenameWithHttpInfo(space = space, filename = filename)
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun getTeamFilesBySpaceByFilenameWithHttpInfo(space: kotlin.String, filename: kotlin.String) : ApiResponse<java.io.File?> {
        val localVariableConfig = getTeamFilesBySpaceByFilenameRequestConfig(space = space, filename = filename)
    ...
    /**
     * To obtain the request config of the operation getTeamFilesBySpaceByFilename
     *
     * @param space 
     * @param filename 
     * @return RequestConfig
     */
    fun getTeamFilesBySpaceByFilenameRequestConfig(space: kotlin.String, filename: kotlin.String) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getTeamRoomsByIdMessages(id: kotlin.String, space: kotlin.String? = null) : TeamMessages {
        val localVarResponse = getTeamRoomsByIdMessagesWithHttpInfo(id = id, space = space)

        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as TeamMessages
            ResponseType.Informational -> throw UnsupportedOperationException("Client does not support Informational responses.")
            ResponseType.Redirection -> throw UnsupportedOperationException("Client does not support Redirection responses.")
            ResponseType.ClientError -> {
                val localVarError = localVarResponse as ClientError<*>
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun getTeamRoomsByIdMessagesWithHttpInfo(id: kotlin.String, space: kotlin.String?) : ApiResponse<TeamMessages?> {
        val localVariableConfig = getTeamRoomsByIdMessagesRequestConfig(id = id, space = space)

        return request<Unit, TeamMessages>(
            localVariableConfig
        )
    }

    /**
     * To obtain the request config of the operation getTeamRoomsByIdMessages
     *
     * @param id ID is the room, from the path. The URL is the authority.
     * @param space Space names the space holding the room, and is required for the reason the bind op requires it: a room id is unique within a space and not across the org, so searching every space for a match would make the answer depend on iteration order. (optional)
     * @return RequestConfig
     */
    fun getTeamRoomsByIdMessagesRequestConfig(id: kotlin.String, space: kotlin.String?) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, kotlin.collections.List<kotlin.String>>()
            .apply {
                if (space != null) {
                    put("space", listOf(space.toString()))
                }
            }
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        localVariableHeaders["Accept"] = "application/json"
        ...
        return RequestConfig(
            method = RequestMethod.GET,
            path = "/v1/team/rooms/{id}/messages".replace("{"+"id"+"}", encodeURIComponent(id.toString())),
            query = localVariableQuery,
            headers = localVariableHeaders,
            requiresAuthentication = true,
            body = localVariableBody
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun postTeamFilesBySpace(space: kotlin.String, body: java.io.File? = null) : java.io.File {
        val localVarResponse = postTeamFilesBySpaceWithHttpInfo(space = space, body = body)
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun postTeamFilesBySpaceWithHttpInfo(space: kotlin.String, body: java.io.File?) : ApiResponse<java.io.File?> {
        val localVariableConfig = postTeamFilesBySpaceRequestConfig(space = space, body = body)
    ...
    /**
     * To obtain the request config of the operation postTeamFilesBySpace
     *
     * @param space 
     * @param body  (optional)
     * @return RequestConfig
     */
    fun postTeamFilesBySpaceRequestConfig(space: kotlin.String, body: java.io.File?) : RequestConfig<java.io.File> {
        ...
        return RequestConfig(
            method = RequestMethod.POST,
            path = "/v1/team/files/{space}".replace("{"+"space"+"}", encodeURIComponent(space.toString())),
            query = localVariableQuery,
            headers = localVariableHeaders,
            requiresAuthentication = true,
            body = localVariableBody
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun postTeamRooms(teamRoomNew: TeamRoomNew) : TeamRoom {
        val localVarResponse = postTeamRoomsWithHttpInfo(teamRoomNew = teamRoomNew)
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun postTeamRoomsWithHttpInfo(teamRoomNew: TeamRoomNew) : ApiResponse<TeamRoom?> {
        val localVariableConfig = postTeamRoomsRequestConfig(teamRoomNew = teamRoomNew)

        return request<TeamRoomNew, TeamRoom>(
            localVariableConfig
        )
    }

    /**
     * To obtain the request config of the operation postTeamRooms
     *
     * @param teamRoomNew 
     * @return RequestConfig
     */
    fun postTeamRoomsRequestConfig(teamRoomNew: TeamRoomNew) : RequestConfig<TeamRoomNew> {
        val localVariableBody = teamRoomNew
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        localVariableHeaders["Content-Type"] = "application/json"
        localVariableHeaders["Accept"] = "application/json"
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun postTeamRoomsByIdMessages(id: kotlin.String, teamMessageWrite: TeamMessageWrite) : TeamMessage {
        val localVarResponse = postTeamRoomsByIdMessagesWithHttpInfo(id = id, teamMessageWrite = teamMessageWrite)

        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as TeamMessage
            ResponseType.Informational -> throw UnsupportedOperationException("Client does not support Informational responses.")
            ResponseType.Redirection -> throw UnsupportedOperationException("Client does not support Redirection responses.")
            ResponseType.ClientError -> {
                val localVarError = localVarResponse as ClientError<*>
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun postTeamRoomsByIdMessagesWithHttpInfo(id: kotlin.String, teamMessageWrite: TeamMessageWrite) : ApiResponse<TeamMessage?> {
        val localVariableConfig = postTeamRoomsByIdMessagesRequestConfig(id = id, teamMessageWrite = teamMessageWrite)

        return request<TeamMessageWrite, TeamMessage>(
            localVariableConfig
        )
    }

    /**
     * To obtain the request config of the operation postTeamRoomsByIdMessages
     *
     * @param id ID is the room to say it in, from the path.
     * @param teamMessageWrite 
     * @return RequestConfig
     */
    fun postTeamRoomsByIdMessagesRequestConfig(id: kotlin.String, teamMessageWrite: TeamMessageWrite) : RequestConfig<TeamMessageWrite> {
        val localVariableBody = teamMessageWrite
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        localVariableHeaders["Content-Type"] = "application/json"
        localVariableHeaders["Accept"] = "application/json"
